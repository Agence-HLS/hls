...
import { faEarListen,faClock,faComment,faRotate,faHeart,faHandshake } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <>
      ...
      <main className=" flex flex-col">
        <section className=" dark:bg-black containblue">
          <div className="flex justify-center">

            <div className="dark:contain-darkpurple containblue lg:mt-10 mt-32 w-5/6">
            
              <div className="flex justify-center p-4 containblueblue">

              <div className=" flex flex-col items-center p-2 containwhite w-full lg:w-1/4">
              ...
              <div className=" dark:contain-darkgrey containblue text-[#99ecef] dark:text-[#ff66c4]">
                ...
                <div className="flex flex-col items-center pt-3">
                  ...
                  <p className="py-4 px-10 ">
                    Nous somme une entreprise qui propose des services sur le
                    devellopement web, ont est une équipe constitué de 3 jeunes
                    Devellopeur Web et Web Mobile qui vous offre ces services et
                    des conseils sur vos projets de site web
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="">
            <div className="flex justify-center my-10">
              <div className="containblue w-5/6">
                
 <div className="flex justify-center containblueblue p-4" >

            <div className="p-2 w-full lg:w-1/4 flex justify-center containwhite">
              <h1 className="dark:text-white uppercase  ">pourquoi nous?</h1>
 </div>
            </div>
            <div className="containblue text-[#99ecef]">
              <div className="flex justify-center">
                <Image
                  src="data:image/jpeg;base64,"
                  alt="test"
          ...
          <section >
            ...
            <div className=" w-5/6 containblue ">
              <div className="containblueblue p-4">
 <div className="flex justify-center">

            <div className=" w-full lg:w-1/4 p-2 containwhite flex justify-center py-2">

            
              <h1 className="uppercase text-[#00000]">nos point fort</h1>
            </div>
              </div>
 </div>

            <div className="flex justify-center items-center">
            <div className="grid grid-cols-2  py-6 containblue w-full text-[#99ecef]">
              <div className="flex justify-center p-">

              <ul className="">
                <ol >
                  <div className="flex justify-center py-2 text-[#1d56b8]">
