  ...
  return (
    <>
      ...
      <main className="dark:bg-black dark:containblueblue containblue dark:text-fuchsia-500 grid grid-cols-1">
        <section className="containblue  w-full">
          <section
           data-aos="fade-down"
           data-aos-delay="1500"
           ...
           data-aos-duration="300"
            className=" containblueblue my-10 mt-36"
          >
          ...
          {/*  */}
          <section className="my-5  grid grid-cols-1 containblueblue">
            <div className="containblue py-10">
              ...
              <div className="mt-5">
                {" "}
                <section className="containblue grid grid-cols-1">
                  <div></div>
