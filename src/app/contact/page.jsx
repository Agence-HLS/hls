    ...
    <>
      ...
      <main className="dark:bg-black  dark:text-fuchsia-500 grid grid-cols-1">
        ...
        <section className=" containblueblue my-10 mt-36">
          ...
          <div className="containblue containpurple ">
            <div className="flex justify-center py-5">
              <div className="containblue containblueblue flex-col   rounded-full w-48">
                <h1
            ...
            <div className=" p-5">
              <div className="">
                <Image
                  ...
                  width={6000}
                  height={550}
                  className="flex items-center containwhite"
                />
              </div>
            </div>
          </div>
        ...
        {/*  */}
        <section className="my-8  grid grid-cols-1 containblue">
          <div className="containblueblue">
            <form action="" className="items-center flex flex-col py-7 space-y-8">
              ...
              <div className="flex flex-col items-center  pt-4">
                ...
                <textarea
                  ...
                  cols="38"
                  rows="5"
                  className="border-2 pb-5 rounded-lg w-64 "
                />
              </div>
            ...
            <div className=" my-5">
              {" "}
              <section className="containblue grid grid-cols-3 py-10">
                <div className="flex flex-col items-center">
                  <FontAwesomeIcon
