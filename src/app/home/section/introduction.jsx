  ...
  return (
    <>
      <main className="dark:text-fuchsia-500 dark:bg-black  contain-bg flex flex-col containblue ">
        <div className="mt-28 lg:mt-0 w-full h-screen bg-[url('/deep.jpg')] text-[#99ecef]  bg-no-repeat bg-cover bg-center pt-5 font-ocean outline-cyan-50">
        ...
        <section className="my-10 text-[#1d56b8] mt-15 mx-2 lg:mx-96">
          ...
          >
            <div className="containbluelight rounded-xl b py-1 px-12 p-6 lg:w-full text-center lg:grid lg:justify-items-center">
          ...
          >
            <div className="containbluelight py-1 px-12 lg:w-full text-center lg:grid lg:justify-items-center">
              <h1 className="uppercase py-1 px-10 containwhite lg:py-1 lg:w-1/2">
                nos qualités
              </h1>
            </div>
          ...
          <div
            ...
            data-aos-duration="3000"
          >
            <div className=" containbluelight mb-5 py-1 px-12 lg:w-full lg:grid lg:justify-items-center">
